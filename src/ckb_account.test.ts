...
const normalAccount = {
  privateKey: "0x13b08bb054d5dd04013156dced8ba2ce4d8cc5973e10d905a228ea1abc267e60",
  address: "ckt1qzda0cr08m85hc8jlnfp3zer7xulejywt49kt2rr0vthywaa50xwsqw0q40f6t2slk2pyraxmxqh9z5mu4dl7wc2y595g",
...
const multisigAccount = {
  ...
  output: {
    address: "ckt1qpw9q60tppt7l3j7r09qcp7lxnp3vcanvgha8pmvsa3jplykxn32sqgzvufpl4t0yks2uwyzx82cdlscmglxl0svza0k8",
...
test("multisig account", () => {
  const account = new MultisigAccount(multisigAccount.input.privateKeys, multisigAccount.input.R, multisigAccount.input.M);
